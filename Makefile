...
CFLAGS += -Wall -std=c99 -D_DEFAULT_SOURCE -Wno-missing-braces -g
...
OBJS ?= main.cpp #Change here to compile other things
...
$(PROJECT_NAME): $(OBJS)
	$(CC) -o $(PROJECT_NAME)$(EXT) $(OBJS) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM) -Wall
