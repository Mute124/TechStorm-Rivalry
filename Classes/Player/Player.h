...
class Player : public GameObject, public CameraComp, public PlayerHealthComp
{
...
public:
    ...
    {
        this->setPosition(this->getSelfCamera().position);
...
private:
    ...
    unsigned int m_current = m_max;               // current HP from max.
