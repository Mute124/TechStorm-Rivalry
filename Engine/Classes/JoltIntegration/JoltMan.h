...
{
public:
	JPH_DECLARE_RTTI_VIRTUAL_BASE(JPH_NO_EXPORT, JoltMan)

	// Destructor
	virtual			~JoltMan() = default;
...
#include "../Logging/Logman.h" // We need to connect our logger to Jolt
...
public:
    ...
    JoltMan() {
        ...
        Trace = JoltMan::JoltLogger::TraceImpl;
	...
	JoltMan::BroadLayerInterface broad_phase_layer_interface;
	...
	JoltMan::ObjectBodyActivationListener body_activation_listener;
	physics_system.SetBodyActivationListener(&body_activation_listener);

	// A contact listener gets notified when bodies (are about to) collide, and when they separate again.
	// Note that this is called from a job so whatever you do here needs to be thread safe.
	// Registering one is entirely optional.
	JoltMan::ObjectContactListener contact_listener;
    ...
    void Destroy(BodyInterface &body_interface) {
...
private:
    ...
    // NOTE : This unfortunatly cant be made a function, because it has inherits. ;-;
    ...
    class BroadLayerInterface final : public BroadPhaseLayerInterface
    {
    public:
        BroadLayerInterface()
        {
    ...
    class ObjectBodyActivationListener : public BodyActivationListener
    {
    public:
