...
public:
  ...
  static inline RenderTexture2D GetRenderTexture()
  {
    return Target;
  }

  static inline void StartTextureMode()
  {
    BeginTextureMode(Target);
  }

protected:
  static inline RenderTexture2D Target = LoadRenderTexture(GetScreenWidth(), GetScreenHeight());
