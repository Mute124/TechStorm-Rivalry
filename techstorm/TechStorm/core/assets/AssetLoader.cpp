...
TECHSTORM_NAMESPACE_BEGIN
class AssetLoader {
private:

	static std::map<const char*, Sound> m_sounds;
	static std::map<const char*, Model> m_models;
	static std::map<const char*, Material> m_materials;
	static std::map<const char*, Image> m_images;
	static std::map<const char*, Texture2D> m_textures;
	static std::map<const char*, Music> m_music;
	static std::map<const char*, Font> m_fonts;
