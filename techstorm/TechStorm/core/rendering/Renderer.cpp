...
namespace TechStorm {
	...
	public:
		static int pbrShdrLoc;
		static int bloomShdrLoc;
	...
	public:
		...
		static Vector3 ambientColorNormalized;
		static int lightCountLoc;
		static int emissiveIntensityLoc;
		static int emissiveColorLoc;
		static int textureTilingLoc;
		static Shader pbrShader = { 0 };
